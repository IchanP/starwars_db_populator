    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homeworld', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='residents', to='starwars.planet')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('omeworld', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='starwars.planet')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pilots', models.ManyToManyField(blank=True, related_name='starships', to='starwars.people')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pilots', models.ManyToManyField(blank=True, related_name='vehicles', to='starwars.people')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('characters', models.ManyToManyField(blank=True, related_name='films', to='starwars.people')),
                ('planets', models.ManyToManyField(blank=True, related_name='films', to='starwars.planet')),
                ('species', models.ManyToManyField(blank=True, related_name='films', to='starwars.species')),
                ('starships', models.ManyToManyField(blank=True, related_name='films', to='starwars.starship')),
                ('vehicles', models.ManyToManyField(blank=True, related_name='films', to='starwars.vehicle')),
            ],
            options={
                'abstract': False,
            },
